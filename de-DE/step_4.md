...
Wir können eine **Variable** verwenden, um deinen Namen zu speichern. Klicke auf `Variablen`{:class="block3variables"} und dann auf "neue Variable". Da diese Variable zum Speichern deines Namens verwendet wird, nennen wir die Variable... `Name`{:class="block3variables"}!
...
Um deinen Namen zu speichern, klicke auf die Registerkarte `Variablen`{:class="block3variables"} und ziehe dann den Block `setze Namen`{:class="block3variables"} an das Ende deines Codes.
